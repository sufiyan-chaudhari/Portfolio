...
const Home = () => {
  ...
  return (
    <>
      ...
      >
        <main
          className="sm:pt-96 md:pt-20  pt-0 mx-auto max-w-7xl px-4 sm:px-6  lg:px-8 flex flex-col md:flex-row items-center justify-center md:justify-between h-screen"
          id="/"
        >
          <div className="sm:text-center lg:text-left">
            ...
            >
              ...
              QuadB Technologies as a React JS Developer
            </p>
