  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="">
          <h4 className="sm:mt-16 text-3xl font-semibold text-blue-500">
            What I Provide
          </h4>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {serviceData.map((el, index) => (
              <motion.div
                ...
                className={`${
                  theme.state.darkMode ? "bg-white" : "bg-gray-100"
                } p-4 rounded-lg flex items-center flex-col`}
              >
                <img className="w-20 h-20" src={el.img} alt="" />
